...
export class VitecFetch extends React.Component {
  constructor(props) {
    ...
    var settings = {
      headers: {
        Authorization:
          "Basic NjY6WVNWa2pFdVFhOUxzQ29ENVVJY0I3S09tMGhIRVFMU0R5MU83ZDFtbEZmOXJOM0tpZlhQUlVOcUQzaGsydmd5RQ==",
  ...
  componentDidMount() {
    fetch("https://api.github.com/orgs/lexiconna18/repos", this.settings1)
      .then(res => res.json())
      .then(
        result => {
          this.setState({
